...
def Parsing():
    ...
    parser.add_argument('--hparamPointDimension',     type = int,  required = False, default= 4,              help = 'Point Dimension used for T-NET therefore used in BasePointNet and Segmentation ')
